package uz.soliq.anketa.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.soliq.anketa.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.soliq.anketa.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, uz.soliq.anketa.domain.User.class.getName());
            createCache(cm, uz.soliq.anketa.domain.Authority.class.getName());
