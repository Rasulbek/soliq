...
/**
 * REST controller for managing {@link uz.soliq.anketa.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<JobHistoryDTO> updateJobHistory(@Valid @RequestBody JobHistoryDTO jobHistoryDTO) throws URISyntaxException {
